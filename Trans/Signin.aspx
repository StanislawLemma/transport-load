<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Signin.aspx.cs" Inherits="Trans.Signin" %>
            ...
            <nav class="navbar navbar-expand-lg navbar-dark" style="background-color: #3a634c;">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <div class="form-inline my-2 my-lg-0">
                        <asp:Button ID="btnSignIn" runat="server" CssClass="btn btn-outline-success my-2 my-sm-0 btn-sm" Text="Sign In" OnClick="btnSignIn_Click" />
                    </div>
                </div>
            </nav>
        </div>
