<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="Trans.Default" %>
...
<head runat="server">
    ...
    <%--<link href='http://fonts.googleapis.com/css?family=Abel|Cinzel' rel='stylesheet' type='text/css'>
    ...
    <%--https://fonts.googleapis.com/css?family=Tangerine|Inconsolata|Droid+Sans Pipe ile birden fazla import edebiliriz--%>
    <%--<p>
    ...
    <form id="form1" runat="server">
        ...
        <div class="container">
            <div class="form-horizontal">
                ...
                <div class="form-row">
                    <div class="col-3">
                        <asp:Label ID="Label10" runat="server" CssClass="col-form-label" Text="Pick Date Start"></asp:Label>
                    ...
                    <div class="col-3">
                        <asp:Label ID="Label9" runat="server" CssClass="col-form-label" Text="Pick Date End"></asp:Label>
